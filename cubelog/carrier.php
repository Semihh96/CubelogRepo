            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="contact-details__right">
                        <div class="sec-title">
                            <span class="sub-title">BRAUCHEN SIE HILFE?</span>
                            <h2>Carriere</h2>
                            <div class="text">Wir stellen ein! Ihre Zukunft bei Cubelog.Sie suchen nach einer neuen beruflichen Herausforderung? Dann sind Sie bei Cubelog genau
                                richtig. In unserem Unternehmen gibt es viele hervorragende Chancen für Sie.
                                Unsere Stellenangebote: Sachbearbeiter (m/w/d), Buchhalter (m/w/d)
                                Neben unseren ausgeschriebenen Stellenangeboten und Ausbildungen freuen wir uns auf Ihre
                                Initiativbewerbung. Schreiben Sie uns gerne unter karriere@cubelog.de an. </div>
                        </div>
                    </div>
                </div>
            </div>
